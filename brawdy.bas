...
__CheckCollision
   ...
   if (temp4 + 5) >= player3y && temp4 <= (player3y + 5) then player3y=200 : Househit=Househit+1 : Bit5_hit{5} =1 : goto __Explosion
...
__Skip_p0_Collision
   ...
   if EnemyHit < 3 then if (missile0y + missile0height) >= player3y && missile0y <= (player3y + 10) && (missile0x + temp5) >= player3x && missile0x <= (player3x + 15) then EnemyHit = 3 : Points=$15 : goto __Score
...
__Playfield1
 ...
 if level = 3 then goto __Playfield2
 temp5 = rand : if level > 4 && temp5 < 128  then goto __Playfield2
   REdge =51
   LEdge =25
_PlayfieldLevel1
  playfield:
   ...
   ;if level >2 then goto __Playfield2
   goto __Colors
...
__PFColors4
   player5x =LEdge+ 15: player5y =104 
